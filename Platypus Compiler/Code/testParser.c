 ...
 *  CST8152 - Compilers
 *  Version: 1.20.1
 *  Author: Svillen Ranev - updated: Paulo Sousa
 *  Date: 10 Nov 2020
 *************************************************************/
...
extern void processParser(void);
extern void initScanner(pBuffer sc_buf);
/* For testing purposes */
/* extern Token malpar_next_token(void);*/

static void printParserError(char* fmt, ...);
static void displayParser(pBuffer ptrBuffer);
...
/* __DATE__, __TIME__, __LINE__, __FILE__, __STDC__ are predefined preprocessor macros*/
	...
	loadsize = bufferLoad(fi, sourceBuffer);
	...
	if (bufferSetEnd(sourceBuffer, EOF)) {
